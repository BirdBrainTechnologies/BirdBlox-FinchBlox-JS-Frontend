...
NewInputPad.addWidget = function(widget){
	this.widgets.push(widget);
};
NewInputPad.show = function(slotShape, updateFn, finishFn, data){
	const IP = NewInputPad;
...
NewInputPad.prototype.showWidgets = function(){
	...
	for(let i = 0; i < this.widgets.length; i++) {
		this.widgets[i].show(0, y, this.slotShape, this.updateFn.bind(this), this.finishFn.bind(this));
