...
Block.setDisplaySuffix(B_HBDistInch, "inches");/* This file contains the implementations for Blocks in the operators category.
 * Each has a constructor which adds the parts specific to the Block and overrides methods relating to execution.
 */
...
BoolSlot.prototype.constructor = BoolSlot;//@fix Write documentation.
...
CommandBlock.prototype.constructor = CommandBlock;function ConnectMultipleHBDialog(){
...
DoubleLoopBlock.prototype.constructor = DoubleLoopBlock;function DropSlot(parent,key,snapType){
	if(snapType==null){
		snapType=Slot.snapTypes.none;
	}
...
HatBlock.prototype.constructor = HatBlock;function HBConnectionList(x,upperY,lowerY,hBToReplace){
...
LoopBlock.prototype.constructor = LoopBlock;function Menu(button,width){
	if(width==null){
...
NumSlot.prototype.constructor = NumSlot;function OpenDialog(listOfFiles){
...
PortSlot.prototype.constructor = PortSlot;/* Child of Block. The CommandBlock is for Blocks that return booleans.
 * @constructor
 * @param {number} x - The x coord for the Block.
 * @param {number} y - The y coord for the Block.
 * @param {string} category - The Block's category in string form. Used mainly to color it.
...
ReporterBlock.prototype.constructor = ReporterBlock;function ResultBubble(leftX,rightX,upperY,lowerY,text, error){
	var RB = ResultBubble;
	if(error == null){
		error = false;
	}
...
StringSlot.prototype.constructor = StringSlot;function Tab(){
