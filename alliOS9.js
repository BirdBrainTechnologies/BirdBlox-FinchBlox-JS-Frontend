...
DeviceManager.prototype.fromJsonArrayString = function(robotListString, includeConnected, excludeIndex) {
	...
	var robotList = Device.fromJsonArrayString(this.deviceClass, robotListString);
...
BlockList.populateCat_sound = function(category) {
	var button = category.addButton("Record sounds", RecordingDialog.showDialog, true);
...
RowDialog.prototype.createHintText = function() {
	...
	var y = this.scrollBoxY + RD.hintTextFont.charHeight + RD.hintMargin;
...
ConnectMultipleDialog.prototype.createConnectBn = function() {
	...
	var manager = this.deviceClass.getManager();
...
RobotConnectionList.prototype.updateRobotList = function(jsonArray) {
	...
	var robotArray = this.deviceClass.getManager().fromJsonArrayString(jsonArray, includeConnected, this.index);
